...
const TestimonialCardCustomer = ({
  ...
  return (
    <div
      {...props}
      className="flex h-full max-w-[350px] flex-col rounded-xl bg-white p-8 text-black"
    >
...
const TestimonialCardSocial = ({
  ...
  return (
    <div
      {...props}
      className=" flex h-full max-w-[350px] flex-col overflow-hidden rounded-xl bg-white text-start text-black "
    >
      <div className="space-y-6">
